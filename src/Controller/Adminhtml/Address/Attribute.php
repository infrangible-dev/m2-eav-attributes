...
namespace Infrangible\EavAttributes\Controller\Adminhtml\Address;
...
abstract class Attribute extends \Infrangible\EavAttributes\Controller\Adminhtml\Attribute
{
    ...
    {
        return $this->createActionPage([__('Customer'), __('Address Attributes'), $title],
            'Infrangible_EavAttributes::address_attributes');
    }
    ...
    {
        return \Infrangible\EavAttributes\Block\Adminhtml\Address\Attribute::class;
    }
    ...
    protected function saveEntityAttributeData(Entity\Attribute $attribute): void
    {
        ...
        if (! $entityAttributeId) {
            $entityType = $this->entityTypeHelper->getCustomerAddressEntityType();
